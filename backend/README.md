...
## Project Structure
    ...
    ├── testapiautosetting_125083  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125083`
...
2. Clone this repo and `cd testapiautosetting_125083`
